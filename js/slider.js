...
$(".feetback__slider").slick({
  infinite: true,
  slidesToShow: 1,
  slidesToScroll: 1,
  prevArrow:
    '<div class="arrow-container arrow__left"><img class="arrow" src="img/feetback/left_arrow.png" alt="arrow"/></div>',
  nextArrow:
    '<div class="arrow-container arrow__right"><img class="arrow" src="img/feetback/right_arrow.png" alt="arrow"/></div>',
});
